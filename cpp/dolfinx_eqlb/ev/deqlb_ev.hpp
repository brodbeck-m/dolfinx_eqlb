...
/// @brief Flux equilibration functionalities of the Ern and Vohralík type.
///
/// Classes and algorithms for the equilibration of fluxes and stresses based on
/// the approach of Ern and Vohralík [1] and a weakly symmetric equilibration of
/// stresses following [2].
///
